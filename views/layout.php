...
<body>
    ...
    <!-- Page Header -->
    <header class="masthead" style="background-image: url('img/ecran.png')">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 col-md-10 mx-auto">
                    <ul class="list-inline text-center">
                        <li class="list-inline-item">
                            <a href="https://fr.linkedin.com/in/matthieu-wahba-9b5813136" target="_blank">
                        ...
                        <li class="list-inline-item">
                            <a href="https://github.com/Wahba-mat" target="_blank">
                                <span class="fa-stack fa-lg">
                                    <i class="fa fa-circle fa-stack-2x"></i>
                    ...
                    <p class="copyright text-muted">Copyright &copy; Projet Blog 2019</p>
                </div>
            </div>
        </div>
    </footer>
